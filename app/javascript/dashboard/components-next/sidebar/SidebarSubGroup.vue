...
<template>
  ...
  <ul v-if="children.length" class="m-0 list-none reset-base relative group">
    ...
    <div
      ...
      v-show="!scrollEnd"
      class="absolute bg-gradient-to-t from-[#0066ff] w-full h-12 to-transparent -bottom-1 pointer-events-none flex items-end justify-end px-2 animate-fade-in-up"
    >
      <svg
        width="16"
        height="24"
        viewBox="0 0 16 24"
        fill="none"
        class="text-white/70 opacity-50 group-hover:opacity-100"
